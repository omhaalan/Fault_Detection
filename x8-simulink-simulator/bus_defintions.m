...
StabilityParams = Simulink.Bus; 
StabilityParams.Elements = Simulink.BusElement;
StabilityParams.Elements(1).Name  =  'C_L_alpha';
StabilityParams.Elements(2).Name  =  'C_L_q'    ;
StabilityParams.Elements(3).Name  =  'C_D_alpha';
StabilityParams.Elements(4).Name  =  'C_D_q'    ;
StabilityParams.Elements(5).Name  =  'C_m_alpha';
StabilityParams.Elements(6).Name  =  'C_m_q'    ;
StabilityParams.Elements(7).Name  =  'C_Y_beta' ;
StabilityParams.Elements(8).Name  =  'C_Y_p'    ;
StabilityParams.Elements(9).Name  =  'C_Y_r'    ;
StabilityParams.Elements(10).Name =  'C_l_beta' ;
StabilityParams.Elements(11).Name =  'C_l_p'    ;
StabilityParams.Elements(12).Name =  'C_l_r'    ;
StabilityParams.Elements(13).Name =  'C_n_beta' ;
StabilityParams.Elements(14).Name =  'C_n_p'    ;
StabilityParams.Elements(15).Name =  'C_n_r'    ;
StabilityParams.Elements(1).DataType = 'double';
StabilityParams.Elements(2).DataType = 'double';
StabilityParams.Elements(3).DataType = 'double';
StabilityParams.Elements(4).DataType = 'double';
StabilityParams.Elements(5).DataType = 'double';
StabilityParams.Elements(6).DataType = 'double';
StabilityParams.Elements(7).DataType = 'double';
StabilityParams.Elements(8).DataType = 'double';
StabilityParams.Elements(9).DataType = 'double';
StabilityParams.Elements(10).DataType = 'double';
StabilityParams.Elements(11).DataType = 'double';
StabilityParams.Elements(12).DataType = 'double';
StabilityParams.Elements(13).DataType = 'double';
StabilityParams.Elements(14).DataType = 'double';
StabilityParams.Elements(15).DataType = 'double';
