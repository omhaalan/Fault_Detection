function [thrust,torque,omega,I_a,U_out, faultParams] = motor_fault(throttle, Va,fault, time)
    ...
    switch fault 
        ...
        case 4
            ...
            C_D_0_W = paramDynamics(C_D_0_W, 1.521809242147078e-06, riseTime, time);
            C_D_J_W = paramDynamics(C_D_J_W, 1.471702181079043e-06, riseTime, time);
            C_D_J_2_W = paramDynamics(C_D_J_2_W, -3.371080936579000e-06, riseTime, time);
            
            C_T_J_W = -0.1225/4/pi^2*prop_diam^4*rho;
            C_T_0_W = 0.1148/4/pi^2*prop_diam^4*rho;
        case 5
            c_v = paramDynamics(c_v, c_v+5e-8, riseTime, time);
        case 6
            I_0 = paramDynamics(I_0, 2*I_0, riseTime, time);
    end
